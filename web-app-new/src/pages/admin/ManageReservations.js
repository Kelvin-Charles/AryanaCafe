...
const ManageReservations = () => {
  ...
  const { data: reservations = [], loading, error, execute: fetchReservations } = useApi(api.reservations.getAll);
      ...
      <div className="flex-1 p-8">
        ...
        <div className="bg-white p-6 rounded-lg shadow">
          {loading ? (
            ...
            <div>Error loading reservations: {error}</div>
          ) : (
            ...
            <div className="bg-white p-6 rounded-lg max-w-lg w-full">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p>{format(new Date(selectedReservation.date), 'MMMM dd, yyyy')}</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className={`inline-block px-2 py-1 rounded text-sm ${getStatusColor(selectedReservation.status)}`}>
