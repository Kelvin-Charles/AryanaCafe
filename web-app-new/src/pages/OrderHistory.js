...
const OrderHistory = () => {
  ...
  const { data, loading, error, execute: fetchOrders } = useApi(api.orders.getMyOrders);
  const orders = data || [];
              ...
              <tbody>
                {orders.map((order) => (
                  <tr key={order.id}>
                    ...
                    <td className="border px-4 py-2">
                      TSh {calculateTotal(order.items).toLocaleString()}
                    </td>
                    <td className="border px-4 py-2">
                ...
                <table className="w-full">
                  ...
                  <tbody>
                    ...
                    <tr className="border-t bg-gray-50 font-bold">
                      ...
                      <td className="px-4 py-2 text-right">TSh {calculateTotal(selectedOrder.items).toLocaleString()}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
